...
namespace Cosmos.IL2CPU.X86.IL
{
  ...
  public class Newarr : ILOp
  {
    ...
    public override void Execute(MethodInfo aMethod, ILOpCode aOpCode)
    {
      ...
      XS.Add(EAX, ObjectInfo.FieldDataOffset + 4); // total srray size
      XS.Push(EAX);
      ...
      XS.Set(EAX, (uint)ObjectInfo.InstanceTypeEnum.Array, destinationDisplacement: 4, destinationIsIndirect: true);
