                ...
                */
                ...
                if (TypeIsReferenceType(xPopType))
                {
                    ...
                    */
                    ...
                    XS.Set(EAX, ESP, sourceDisplacement: (int)xThisOffset + 4);
                    XS.Compare(EAX, (int)ObjectInfo.InstanceTypeEnum.BoxedValueType, destinationIsIndirect: true, destinationDisplacement: 4, size: RegisterSize.Int32);
                    ...
                    * EAX contains the type pointer (not the handle!!)
                    */
                    XS.Add(EAX, (uint)ObjectInfo.FieldDataOffset);
