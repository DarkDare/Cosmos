...
namespace Cosmos.Core.Common
{
    public abstract class IOPortBase
    {
        ...
        [PlugMethod(AssemblerName = "IOPortWrite8")]
        protected static void Write8(UInt16 aPort, byte aData)
        {
            throw new NotImplementedException();
        }

        [PlugMethod(AssemblerName = "IOPortWrite16")]
        protected static void Write16(UInt16 aPort, UInt16 aData)
        {
            throw new NotImplementedException();
        }

        [PlugMethod(AssemblerName = "IOPortWrite32")]
        protected static void Write32(UInt16 aPort, UInt32 aData)
        {
            throw new NotImplementedException();
        }

        [PlugMethod(AssemblerName = "IOPortRead8")]
        protected static byte Read8(UInt16 aPort)
        {
            throw new NotImplementedException();
        }

        [PlugMethod(AssemblerName = "IOPortRead16")]
        protected static UInt16 Read16(UInt16 aPort)
        {
            throw new NotImplementedException();
        }

        [PlugMethod(AssemblerName = "IOPortRead32")]
    ...
    public class IOPort : IOPortBase
    {
        ...
        public UInt16 Word
        {
            get
            {
                return IOPortBase.Read16(Port);
            }
            set
            {
                IOPortBase.Write16(Port, value);
            }
        }
        ...
        public UInt32 DWord
        {
            get
            {
                return IOPortBase.Read32(Port);
            }
            set
            {
                IOPortBase.Write32(Port, value);
            }
        }
    }
